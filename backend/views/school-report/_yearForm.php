...
<div class="year_evaluation">
    <div class="removeYear_button"><?= Html::button('Remove this year', ['class' => 'btn btn-info']) ?></div>
    <div class="title"><?= 'Đánh giá năm học'?></div>
    <div class="part1">
        <div class="fromYear"><span class="fLabel">Từ năm</span> <?= $form->field($studyProcess_model, "[$i]fromYear")->textInput(['value' => $studyProcess != null ? $studyProcess->fromYear : null, 'class' => 'test']) ?>
            ...
            <tbody>
                ...
                <tr class="subject_row">
                    ...
                    <?php
                        ...
                        echo $form->field($subjectScore, "[$i][1][$subject->name]score")->textInput(['class' => 'input']);
                    ?>
                    </td>
                    <td>
                    <?php
                        ...
                        echo $form->field($subjectScore, "[$i][2][$subject->name]score")->textInput(['class' => 'input']);
                    ?>  
                    </td>
                    <td>
                    <?php
                        ...
                        echo $form->field($subjectScore, "[$i][0][$subject->name]score")->textInput(['class' => 'input']);
                    ?>  
                    </td>
                    <td></td>
                    <td><?= $form->field($subjectScore, "[$i][$subject->name]teacherName")->textInput([
                        'class' => 'input']) ?>
                    </td>
                </tr>
                <?php } ?>
        ...
        <table>
            <tr class="title_row">
                ...
                <td class="upgrade" rowspan="5">
                    ...
                    echo 'Loại lên lớp ' . $form->field($yearEvaluation, "[$i]upGradeType")
                        ...
                        <?php
                            if($yearE != null) {
                                for ($j=0; $j < sizeof($yearE->achievements); $j++) { 
                                    ...
                                    echo $form->field($achievement, "[$i][$j]name")->textInput(['class' => 'input']);
                                }
                            } else {
